...
router.post('/', upload_middleware_1.upload.single('invoice'), transaction_controller_1.addTransaction);
...
router.put('/:id', upload_middleware_1.upload.single('invoice'), transaction_controller_1.updateTransaction);
