...
exports.processDailyReminders = void 0;
const supabase_1 = require("../database/supabase");
const email_service_1 = require("./email.service");
const processDailyReminders = () => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    try {
        ...
        const { data: profiles, error: profError } = yield supabase_1.supabase
            .from('profiles')
        ...
        const { data: parties, error } = yield supabase_1.supabase
            .from('parties')
        ...
        for (const party of parties) {
            ...
            if (lastSent && lastSent.toDateString() !== now.toDateString()) {
                sentToday = 0;
                yield supabase_1.supabase.from('parties').update({ reminders_sent_today: 0 }).eq('id', party.id);
            }
            ...
            if (shouldSend) {
                const senderName = ((_a = party.profiles) === null || _a === void 0 ? void 0 : _a.full_name) || 'Daily-KHATA User';
...
exports.processDailyReminders = processDailyReminders;
